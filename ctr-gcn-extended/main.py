...
from torchlight.utils.mmcv.config import DictAction
...
def get_parser():
    ...
    parser.add_argument(
        '--work-dir',
        default='./work_dir/ntu60/xsub/ctrgcn',
    ...
    # model
    parser.add_argument('--model', default='./model/ctrgcn.py', help='the model will be used')
    parser.add_argument(
        '--model-args',
        action=DictAction,
        default=dict(),
